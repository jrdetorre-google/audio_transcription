...
class AudioTranscription:
    ...
    def transcribe(self, audio_file_path, output_csv_file):
        ...
        msg1_text1 = types.Part.from_text(text="""Convierte este audio correspondiente a una llamada a un centro de atención telefónica a texto. 
            ...
            Número de línea: Código secuencial correspondiente a cada nueva línea 
            Hablante: Hablante que interviene en cada nueva secuencia del mensaje. Si es una secuencia con silencio identifícalo con hablante \"Silencio\" 
            Tiempo inicio: Tiempo de inicio de cada secuencia del mensaje, expresado con respecto al inicio de la llamada expresado en minutos:segundos 
            Tiempo fin: Tiempo de fin de cada secuencia del mensaje, expresado con respecto al inicio de la llamada expresado en minutos:segundos 
            Duración: La duración de la secuencia. debería ser igual a Tiempo fin - Tiempo inicial expresado en minutos:segundos 
            Código Lenguaje: Código iso del, por ejemplo es-es, es-co, en-en... 
            Mensaje: Texto escrito de la secuencia del mensaje. Si hay alguna secuencia con silencio introduce aquí alguna descripción de qué está pasando, si hay ruido de fondo, de qué tipo o cualquier mensaje descriptivo que consideres importante. No inventes, por favor. 
            Tono. Emoción principal de la secuencia. Interesa principalmente Neutra, Irritada, Conciliadora, pero incluye cualquier otra que necesites 
            Alerta: Rellena este campo con \"Ojo\", si ves que hay palabras malsonantes, amenazas, una falta de respeto o la conversación es violenta. Déjalo vacío si no es el caso. No pongas otras cosas que no sea \"Ojo\" 
            Datos personales: Incluye aquí los datos personales que identifiques en la secuencia. Puede ser una identidad con nombre y apellidos, una dirección, un identificador de cliente...             
            """)
...
if __name__ == "__main__":
    ...
    audio_transcription.transcribe("gs://gana_recordings/call.wav", "transcripcion_2506271819.csv")
